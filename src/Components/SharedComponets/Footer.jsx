        ...
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <aside>
                    ...
                    <p>KingLion Hotel<br />Providing reliable housing since 1999</p>
                </aside>
                <nav>

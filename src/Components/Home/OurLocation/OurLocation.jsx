...
const OurLocation = () => {
    ...
    return (
        <section className="lg:px-5 md:px-5 px-2 bg-center bg-no-repeat bg-cover py-9 mb-10" style={{ 
          ...
          <div className="flex  lg:flex-row md:flex-row flex-col-reverse   max-w  border-gray-600  rounded-md p-0">
             <div className="h-full w-full border-[20px] border-[#3930308e] overflow-hidden rounded-l-lg">
             <Map  height={300} defaultCenter={[24.8862, 91.8813]} defaultZoom={11} >
                <Marker width={100} anchor={[24.8862, 91.8813]} />
            </Map>
             </div>
            
            <div className=" p-4 text-gray-100 col-span-1 rounder-lg bg-[#3930308e]">
